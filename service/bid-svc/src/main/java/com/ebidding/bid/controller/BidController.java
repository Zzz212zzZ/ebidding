...
//    }
    ...
    @GetMapping("/getSuccesBidByBwicid")
    public  ResponseEntity<Bid> getSuccesBidByBwicid(@RequestParam("bwicId") Long bwicId){
        return ResponseEntity.ok(this.bidService.getSuccesBidByBwicid(bwicId));
    }
